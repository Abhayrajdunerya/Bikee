            ...
            <aside id="default-sidebar" className={`absolute top-0 left-0 z-40 w-64 h-screen transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} -translate-x-full sm:translate-x-0`} aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto ">
                    <ul className="space-y-2 font-medium">
                        <DashLink title={'Orders'} url={'/admin/dashboard'} icon={<FaShoppingBag />} />
                        <DashLink title={'Pizzas'} url={'/admin/pizza'} icon={<FaPizzaSlice />} />
                        <DashLink title={'Ingredients'} url={'/admin/ingredient'} icon={<BiSolidDashboard />} />
                        <DashLink title={'Sub Ingredients'} url={'/admin/sub-ingredient'} icon={<BiSolidDashboard />} />
                        <DashLink title={'Add Pizza'} url={'/admin/add-pizza'} icon={<BiSolidMessageAltAdd />} />
                        <DashLink title={'Add Stock'} url={'/admin/add-stock'} icon={<BiSolidMessageAltAdd />} />
                        <div onClick={() => setSidebarOpen(false)} className="sm:hidden">
                            <DashLink title={'Close Sidebar'} url={''} icon={<BiSolidMessageAltAdd />} />
                        </div>
