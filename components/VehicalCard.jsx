...
//   const carRent = calculateCarRent(city_mpg, year);
  ...
  return (
    <div className="car-card group max-w-sm">
      ...
      <div className='relative w-full h-40 my-3 mb-11 object-contain'>
      ...
      <VehicalDetails isOpen={isOpen} closeModal={() => setIsOpen(false)} car={car} />
    </div>
  );
};
