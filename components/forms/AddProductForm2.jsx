...
import { addVehicle } from '@/libs/vehicle'
import { toast } from 'react-toastify'

const AddProductForm2 = ({ type, renterId, setLoading }) => {
  ...
  const handleClick = async () => {
    if (!vin || !brand || !model || !mfYear || !fuel || !engineCap || !startType || !images.length ||
      ...
      try {
        const response = await addVehicle(brand, model, mfYear, fuel, engineCap, startType, vin, renterId, images, type, {hourly, daily, weekly, monthly}, depositeAmt, preHourCharge, terms)
